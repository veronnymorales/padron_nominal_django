...
urlpatterns = [
    ...
    #-- microredes excel
    path('rpt_paquete_compromiso_microred_excel/', RptPaqueteCompromiso.as_view(), name = 'rpt_paquete_compromiso_microred_xls'),
    ...
    path('rpt_paquete_compromiso_establec_excel/', RptPaqueteCompromiso.as_view(), name = 'rpt_paquete_compromiso_establecimiento_xls'),
    ...
    #-- provincia excel
    path('rpt_paquete_compromiso_provincia_excel/', RptPaqueteCompromiso.as_view(), name = 'rpt_paquete_compromiso_provincia_xls'),
    ...
    #-- distrito excel
    path('rpt_paquete_compromiso_distrito_excel/', RptPaqueteCompromiso.as_view(), name = 'rpt_paquete_compromiso_distrito_xls'),
